package com.example.famille.controller.ui.celibataires;
...
public class CelibatairesFragment extends Fragment {

    private CelibatairesViewModel mViewModel;
    public static ArrayList<Person> persons ;
    RecyclerView rv_celibataire;
    PersonAdapter personAdapter;
    public static CelibatairesFragment newInstance() {
        return new CelibatairesFragment();
    }
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container,
        ...
        View root = inflater.inflate(R.layout.celibataires_fragment, container, false);
        rv_celibataire = (RecyclerView) root.findViewById(R.id.rv_celibataire);
        getPerson();




        rv_celibataire.setLayoutManager(new LinearLayoutManager(getActivity()));
    ...
    public void getPerson(){
        ...
        Request myGetRequest = new Request.Builder()
                .url(App.url+"/person/celibataires")
                .get()
                .build();

        Log.d("APP", String.valueOf(App.url+"/person/celibataires"));
                ...
                getActivity().runOnUiThread(new Runnable() {
                    ...
                    public void run() {
                        ...
                        try {
                            ...
                            rv_celibataire.setAdapter(personAdapter);
