package com.example.famille.controller.ui.etudiants;
...
public class EtudiantFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container,
        ...
        View root =  inflater.inflate(R.layout.etudiant_fragment, container, false);
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        mViewModel = ViewModelProviders.of(this).get(EtudiantViewModel.class);
    ...
    public void getPerson(){
        ...
        Request myGetRequest = new Request.Builder()
                .url(App.url+"/person/etudiants")
                .get()
                .build();

        Log.d("APP", String.valueOf(App.url+"/person/etudiants"));
