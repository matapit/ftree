package com.example.famille.controller.ui.maries;
...
public class MariesFragment extends Fragment {

    private MariesViewModel mViewModel;
    public static ArrayList<Person> persons ;
    RecyclerView rv;
    PersonAdapter personAdapter;
    public static MariesFragment newInstance() {
        return new MariesFragment();
    }
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container,
        ...
        View root =  inflater.inflate(R.layout.maries_fragment, container, false);
        rv = (RecyclerView) root.findViewById(R.id.rv_marie);
        getPerson();
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        mViewModel = ViewModelProviders.of(this).get(MariesViewModel.class);
    ...
    public void getPerson(){
        ...
        Request myGetRequest = new Request.Builder()
                .url(App.url+"/person/maries")
                .post(formBody)
                .build();

        Log.d("APP", String.valueOf(App.url+"/person/maries"));
