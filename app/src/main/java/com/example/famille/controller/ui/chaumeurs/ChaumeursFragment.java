package com.example.famille.controller.ui.chaumeurs;
...
import com.example.famille.controller.ui.celibataires.CelibatairesViewModel;
...
public class ChaumeursFragment extends Fragment {

    private ChaumeursViewModel mViewModel;

    public static ArrayList<Person> persons ;
    RecyclerView rv;
    PersonAdapter personAdapter;
    public static ChaumeursFragment newInstance() {
        return new ChaumeursFragment();
    }
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container,
        ...
        View root =  inflater.inflate(R.layout.chaumeurs_fragment, container, false);
        rv = (RecyclerView) root.findViewById(R.id.rv_chaumeur);
        getPerson();
    ...
    public void getPerson(){
        ...
        Request myGetRequest = new Request.Builder()
                .url(App.url+"/person/chaumeurs")
                .get()
                .build();

        Log.d("APP", String.valueOf(App.url+"/person/chaumeurs"));
