package com.example.famille.controller.ui.decedes;
...
public class DecedesFragment extends Fragment {

    private DecedesViewModel mViewModel;
    public static ArrayList<Person> persons ;
    RecyclerView rv;
    PersonAdapter personAdapter;
    public static DecedesFragment newInstance() {
        return new DecedesFragment();
    }
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container,
        ...
        View root =  inflater.inflate(R.layout.decedes_fragment, container, false);
        rv = (RecyclerView) root.findViewById(R.id.rv_decede);
        getPerson();
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        mViewModel = ViewModelProviders.of(this).get(DecedesViewModel.class);
    ...
    public void getPerson(){
        ...
        Request myGetRequest = new Request.Builder()
                .url(App.url+"/person/decedes")
                .get()
                .build();

        Log.d("APP", String.valueOf(App.url+"/person/decedes"));
