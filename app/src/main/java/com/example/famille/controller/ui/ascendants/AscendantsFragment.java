package com.example.famille.controller.ui.ascendants;
...
public class AscendantsFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container,
        ...
        View root = inflater.inflate(R.layout.ascendants_fragment, container, false);
        rv_ascendant = (RecyclerView) root.findViewById(R.id.rv_ascendants);
        getPerson();




        rv_ascendant.setLayoutManager(new LinearLayoutManager(getActivity()));
    ...
    public void getPerson(){
        ...
        Request myGetRequest = new Request.Builder()
                .url(App.url+"/person/ascendants")
                .get()
                .build();

        Log.d("APP", String.valueOf(App.url+"/person/ascendants"));
                ...
                getActivity().runOnUiThread(new Runnable() {
                    ...
                    public void run() {
                        ...
                        try {
                            ...
                            Log.d("APP", persons.get(0).getEmploy());
                            personAdapter = new PersonAdapter(persons);
                            rv_ascendant.setAdapter(personAdapter);
